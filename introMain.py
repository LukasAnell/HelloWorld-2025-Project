...
class ResumeReviewerApp:
    ...
    def setup_initial_ui(self):
        ...
        self.text_label = tk.Label(
            self.main_frame, text="Our AI model will apply the highest standards to your resume\nand help you improve it beyond a basic draft",
            font=("Roboto", 14), fg=initial_fg, bg=self.root.cget('bg'), justify=tk.CENTER
        )
        self.text_label.pack(pady=10, padx=20)

        self.info_label = tk.Label(
            self.main_frame, text="Did you know? Recruiters spend only 6–9 seconds scanning a resume before making a decision.\n\n"
    ...
    def setup_final_ui(self):
        ...
        tk.Label(self.main_frame, text="Ready to review your resume.", font=("Roboto", 18), bg=self.root.cget('bg')).pack(pady=20)
